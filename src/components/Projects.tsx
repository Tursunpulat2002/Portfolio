...
const projects: Array<project> = [
  {
    image: "/imgs/job-list.png",
    title: "Job Board App",
    description:
      "I successfully developed a React Native application, akin to a job board similar to Indeed, enabling users to access job listings along with detailed descriptions and requirements. The app seamlessly integrates with the JSearch API, providing real-time access to a wide range of job opportunities and empowering job seekers to make informed career decisions.",
    repo: "https://github.com/Tursunpulat2002/React-Native-JobBoard-App",
    tech: [
      {
        image: "html-5.svg",
        title: "HTML",
